...
function AboutUs() {
  ...
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-content">
        Join us in our mission to create a greener, healthier world. Visit Kanishkaa's Plants today and experience the 
